...
DROP TABLE IF EXISTS `olala3w_calendar`;
...
DROP TABLE IF EXISTS `olala3w_link`;
...
(1, '127.0.0.1', 1563421405, 'url=css/fonts/slick.ttf', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', 0);
...
DROP TABLE IF EXISTS `olala3w_project`;
...
DROP TABLE IF EXISTS `olala3w_project_menu`;
...
DROP TABLE IF EXISTS `olala3w_question`;
