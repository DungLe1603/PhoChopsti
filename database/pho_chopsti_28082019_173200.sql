...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2019 at 12:31 PM
...
(2, 1, 'Menu', 'menu', '', '', '', '', '', 1, 0, 1, 0, 1, 0, 'no', '', 0, 1566980001, 25),
(3, 1, 'Gallery', 'galleery', '', '', '', '', '', 1, 0, 1, 0, 1, 0, 'no', '', 0, 1566980007, 25),
...
(269, '127.0.0.1', 1566986689, 'url=js/swiper.min.js.map', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', 0);
...
--
ALTER TABLE `olala3w_article`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1337;

--
-- AUTO_INCREMENT for table `olala3w_article_menu`
--
ALTER TABLE `olala3w_article_menu`
  MODIFY `article_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=665;
...
--
ALTER TABLE `olala3w_core_privilege`
  MODIFY `privilege_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6052;
...
--
ALTER TABLE `olala3w_link`
  MODIFY `link_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `olala3w_online`
  MODIFY `online_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=270;
...
--
ALTER TABLE `olala3w_uploads_tmp`
  MODIFY `upload_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2548;
