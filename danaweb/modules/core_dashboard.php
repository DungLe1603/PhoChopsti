									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<ul class="nav nav-tabs">
												...
												<li><a href="#question" data-toggle="tab">Hỏi đáp</a>
												</li>
											...
											<div class="tab-content">
												...
												<div class="tab-pane fade" id="question">
													<form id="core_question" method="post" onsubmit="return coreDashboard('core_question', 'question');">
														<?php
														echo showCoreQuestion($role_id);
														?>
													</form>
												</div>
