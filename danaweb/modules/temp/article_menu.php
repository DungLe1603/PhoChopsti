			...
			<div class="panel-body">
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 70%;">
						...
						<tr>
							<td align="right" class="ver-top"><label>Hình đại diện màu:</label></td>
						...
						<?php if($category_id==999999){ ?>
							<tr>
								<td align="right" class="ver-top"><label>Hình đại diện trắng:</label></td>
						...
						<tr>
							...
							<td><textarea class="form-control" name="plus" rows="1">
								<?php echo stripslashes($plus)?></textarea>
							</td>
						</tr>
						<tr>
