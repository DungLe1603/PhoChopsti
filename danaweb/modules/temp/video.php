...
//
function video($act, $typeFunc, $gallery_id, $gallery_menu_id, $name, $slug, $description, $keywords, $img, $link_youtube, $comment, $is_active, $hot, $created_time, $error) {
	global $db, $tth;
				...
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 70%;">
						...
						<tr>
							...
							<td>
								<textarea class="form-control" id="comment" rows="3" name="comment"><?php echo stripslashes($comment)?></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="tth-gp-r"><input class="form-control" type="text" name="title" maxlength="255" value="<?php echo stripslashes($name)?>" ></td>
						</tr>
						<tr>
