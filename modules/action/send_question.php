...
if(isset($_POST['send_question'])) {
	...
	$data = array(
		...
		'comment'=>$db->clearText($txtcomment),
	...
	$send_mail = sendMailFn($txtEmail, $txtName, $email_to, 'Tư vấn khách hàng', $subject, $txtcomment,$message, '', $txtEmail, $txtName);
	if($send_mail == TRUE)
