	...
	<div class="row"> 
			<div class="col-xs-6 col-sm-6-col-md-6">
				<div class="footer-info">
					<div class="info row">
						<div class="col-xs-6 col-sm-6 col-md-6 ft-logo">					
							<img src="<?php echo HOME_URL;?>/images/logoft.svg">
						</div>
						<div class="col-xs-6 col-sm-6 col-md-6 ft-text text-uppercase">
							<p class="ft-contact">Contact<p>
							<p class="ft-logo-tetx">Pho chopsti</p>
						</div>
					</div>
					<div class="info-detail">
						<p>Address: 90 Dong ke, Hoa Khanh, Lien CHieu, Da Nang</p>
						<p>Tel: 0987654321</p>
						<p>Email: pho.chopsti@gmail.com</p>
						<p>Website: pho.chopsti</p>
